...
from txlb.schedulers import schedulerFactory, leastc, roundr
...
class HostMapperTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.proxyServices = [
            Host('web', '127.0.0.1:8080', 'prod', 'leastconns', 'host1', '127.0.0.1:7001', True),
            Host('web', '127.0.0.1:8080', 'prod', 'leastconns', 'host2', '127.0.0.1:7002'),
            Host('web', '127.0.0.1:8080', 'prod', 'leastconns', 'host3', '127.0.0.1:7003'),
            Host('web', '127.0.0.1:8080', 'test', 'leastconns', 'host4', '127.0.0.1:7004', False),
            Host('web', '127.0.0.1:8080', 'test', 'leastconns', 'host5', '127.0.0.1:7005'),
            Host('web', '127.0.0.1:8080', 'test', 'leastconns', 'host6', '127.0.0.1:7006'),
            Host('dns', '127.0.0.1:8053', 'corp', 'leastconns', 'host7', '127.0.0.1:7007', True),
            Host('dns', '127.0.0.1:8053', 'corp', 'leastconns', 'host8', '127.0.0.1:7008'),
        ]
